 ...
 * @author Shehzar
 */
public class DropCourseGUI extends javax.swing.JFrame {

    /**
     * Creates new form DropCourseGUI
     */
//    private JPanel panel;
    ...
    public DropCourseGUI(String _id) throws HeadlessException {
        initComponents();
        setSize(900, 500);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DropCourseGUI.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DropCourseGUI().setVisible(true);
            }
        });
    }
