 ...
 * @author Shehzar
 */
public class GoToAttendance extends javax.swing.JFrame {

    /**
     * Creates new form GoToAttendance
     */
    //String id;
//    private JPanel panel;
    ...
    public GoToAttendance(String _id, String request) throws HeadlessException {
...
//        setTitle("Courses Attendance");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GoToAttendance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GoToAttendance().setVisible(true);
            }
        });
    }
